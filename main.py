...
keywords = ["Multimodal harmful content",  "Harmful video", "Misinformation Detection", "Rumor", "Multimodal Metaphor", "Intent Recognition", "Metaphor Identification", "Content Moderation"] # TODO add more keywords
...
f_is.write("---\n")
f_is.write("**Please check the [Github](https://github.com/pstAmbition/DailyArXiv_contentmoderation) page for a better reading experience and more papers.**\n\n")
